    ...
    <div className='m-0 p-0 bg-gray-100'>
      <nav className=" text-[#1E3A8A] py-3 px-6 flex justify-between items-center">
        ...
        <div className="space-x-4">
          ...
          <Button sx={{color:'whitesmoke',bgcolor:'#1E3A8A',ml:2}} onClick={openSignIn}>
            Login
          </Button>
        </div>
      </nav>
      ...
      <div className="min-h-screen bg-gray-100 text-gray-900">
        <header className="relative h-screen   flex  items-start justify-center text-white text-center p-0 ">
          ...
          <h1 className="text-4xl font-bold text-[#2c50b2] text-left" >Find Your Dream Job Today!</h1>
          <h3 className="text-3xl font-bold text-[#2c50b2] text-left">Connecting Talent with Opportunity
          </h3>
          <div className='w-72 text-left mr-10'>
          
          <p className="mt-2 text-lg font-medium text-[#2d4a98]">Looking for the perfect job? Whether you're a fresh graduate or an experienced professional, we've got thousands of opportunities waiting for you. Explore a variety of industries, find roles that match your skills, and take the next step in your career with ease.</p>
          </div>
          <a href="#feature">
          ...
          <div className='flex justify-center '>
            <img src="bg.png"  className='h-screen' />
          </div>
        ...
        <section className="py-12 px-6" id="feature">
          <h2 className="text-2xl font-bold mb-6 text-center text-[#1E3A8A]">About</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 justify-center">
            ...
            <Card className="bg-white shadow-lg rounded-none overflow-hidden border-2 border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl max-w-xs mx-auto">
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold text-[#1E3A8A]">Advanced Job Search</h3>
            ...
            <Card className="bg-white shadow-lg rounded-none overflow-hidden border-2 border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl max-w-xs mx-auto">
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold text-[#1E3A8A]">Instant Job Alerts</h3>
                <p className="text-gray-600 mt-4">
            ...
            <Card className="bg-white shadow-lg rounded-none overflow-hidden border-2 border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl max-w-xs mx-auto">
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold text-[#1E3A8A]">Company Profiles</h3>
                <p className="text-gray-600 mt-4">
            ...
            <Card className="bg-white shadow-lg rounded-none overflow-hidden border-2 border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl max-w-xs mx-auto">
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold text-[#1E3A8A]">Easy Application</h3>
                <p className="text-gray-600 mt-4">
